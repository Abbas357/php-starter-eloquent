...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="public/vendor/open-iconic/css/open-iconic-bootstrap.min.css">
    <link rel="stylesheet" href="public/vendor/fontawesome/css/all.css"><!-- END PLUGINS STYLES -->
    <!-- BEGIN THEME STYLES -->
  ...
  <body>
          ...
          <div class="top-bar-list">
                      ...
                      <div class="list-group list-group-flush list-group-reflow mb-2">
                        ...
                        <div class="list-group-item py-2">
                          ...
                          <div class="user-avatar user-avatar-sm bg-muted">
                            <img src="public/images/avatars/bootstrap.svg" alt="">
                          </div>
                          <div class="ml-2">
                        ...
                        <div class="list-group-item py-2">
                          <a href="#" class="stretched-link"><span class="sr-only">Go to search result</span></a>
                          <div class="user-avatar user-avatar-sm bg-muted">
                            <img src="public/images/avatars/slack.svg" alt="">
                          </div>
                          <div class="ml-2">
            ...
            <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
                    ...
                    <div class="dropdown-scroll perfect-scrollbar">
                      ...
                      <a href="#" class="dropdown-item unread">
                        <div class="user-avatar">
                          <img src="public/images/avatars/uifaces15.jpg" alt="">
                        </div>
                      ...
                      <a href="#" class="dropdown-item unread">
                        <div class="user-avatar">
                          <img src="public/images/avatars/uifaces16.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="public/images/avatars/uifaces17.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="public/images/avatars/uifaces18.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="public/images/avatars/uifaces19.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="public/images/avatars/uifaces20.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="public/images/avatars/uifaces21.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                ...
                <li class="nav-item dropdown header-nav-dropdown has-notified">
                  ...
                  <div class="dropdown-menu dropdown-menu-rich dropdown-menu-right">
                    ...
                    <div class="dropdown-scroll perfect-scrollbar">
                      ...
                      <a href="#" class="dropdown-item unread">
                        <div class="user-avatar">
                          <img src="public/images/avatars/team1.jpg" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="public/images/avatars/team3.png" alt="">
                        </div>
                        <div class="dropdown-item-body">
                      ...
                      <a href="#" class="dropdown-item">
                        <div class="user-avatar">
                          <img src="public/images/avatars/team2.png" alt="">
                        </div>
                        <div class="dropdown-item-body">
              ...
              <div class="dropdown d-flex">
                <button class="btn-account d-none d-md-flex" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="user-avatar user-avatar-md"><img src="public/images/avatars/profile.jpg" alt=""></span> <span class="account-summary pr-lg-4 d-none d-lg-block"><span class="account-name">Beni Arisandi</span> <span class="account-description">Marketing Manager</span></span></button> <!-- .dropdown-menu -->
      ...
      <aside class="app-aside app-aside-expand-md app-aside-light">
        ...
        <div class="aside-content">
          ...
          <header class="aside-header d-block d-md-none">
            <!-- .btn-account -->
            <button class="btn-account" type="button" data-toggle="collapse" data-target="#dropdown-aside"><span class="user-avatar user-avatar-lg"><img src="public/images/avatars/profile.jpg" alt=""></span> <span class="account-icon"><span class="fa fa-caret-down fa-lg"></span></span> <span class="account-summary"><span class="account-name">Beni Arisandi</span> <span class="account-description">Marketing Manager</span></span></button> <!-- /.btn-account -->
            <!-- .dropdown-aside -->
          ...
          <div class="page">
            ...
            <header class="page-cover">
              <div class="text-center">
                <a href="user-profile.html" class="user-avatar user-avatar-xl"><img src="public/images/avatars/profile.jpg" alt=""></a>
                    ...
                    <div class="list-group list-group-flush list-group-divider">
                      ...
                      <div class="list-group-item">
                        ...
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces2.jpg" alt="Johnny Day"></a>
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces3.jpg" alt="Sarah Bishop"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces5.jpg" alt="Craig Hansen"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces9.jpg" alt="Jane Barnes"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces4.jpg" alt="Nicole Barnett"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces6.jpg" alt="Michael Ward"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces8.jpg" alt="Juan Fuller"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces7.jpg" alt="Julia Silva"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces10.jpg" alt="Joe Hanson"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces11.jpg" alt="Brenda Griffin"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces12.jpg" alt="Ryan Jimenez"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces13.jpg" alt="Bryan Hayes"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces14.jpg" alt="Cynthia Clark"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces16.jpg" alt="Martha Myers"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces15.jpg" alt="Tammy Beck"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces17.jpg" alt="Susan Kelley"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces18.jpg" alt="Albert Newman"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
                      ...
                      <div class="list-group-item">
                        <!-- .list-group-item-figure -->
                        <div class="list-group-item-figure">
                          <a href="#" class="user-avatar"><img src="public/images/avatars/uifaces19.jpg" alt="Kyle Grant"></a>
                        </div><!-- /.list-group-item-figure -->
                        <!-- .list-group-item-body -->
                        <div class="list-group-item-body">
                          <h4 class="list-group-item-title">
    ...
    <script src="public/vendor/bootstrap/js/bootstrap.min.js"></script> <!-- END BASE JS -->
    <!-- BEGIN PLUGINS JS -->
    <script src="public/vendor/pace/pace.min.js"></script>
    <script src="public/vendor/stacked-menu/stacked-menu.min.js"></script>
    <script src="public/vendor/perfect-scrollbar/perfect-scrollbar.min.js"></script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
    <script src="public/js/theme.min.js"></script> <!-- END THEME JS -->
  </body>
</html>