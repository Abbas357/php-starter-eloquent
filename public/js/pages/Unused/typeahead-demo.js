  ...
  _createClass(TypeaheadDemo, [{
    ...
    value: function remote() {
      var bestPictures = new Bloodhound({
        ...
        queryTokenizer: Bloodhound.tokenizers.whitespace,
        prefetch: 'public/data/films/post_1960.json',
        remote: {
          url: 'public/data/films/queries/%QUERY.json',
          wildcard: '%QUERY'
        }
      });
    ...
    value: function multipleDatasets() {
      var nbaTeams = new Bloodhound({
        datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
        queryTokenizer: Bloodhound.tokenizers.whitespace,
        prefetch: 'public/data/nba.json'
      });
      var nhlTeams = new Bloodhound({
        datumTokenizer: Bloodhound.tokenizers.obj.whitespace('team'),
        queryTokenizer: Bloodhound.tokenizers.whitespace,
        prefetch: 'public/data/nhl.json'
      });
